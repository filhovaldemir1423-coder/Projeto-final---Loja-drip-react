...
import sneakerImage2 from '../assets/Sneaker1-PNG.png';
import sneakerImage3 from '../assets/Sneaker2-PNG.png';
import sneakerImage4 from '../assets/Sneaker4-PNG.png';
  ...
  return (
     <section className="relative overflow-hidden py-3 px-4 md:px-8 lg:px-16 bg-[#f0f0f0]">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[500px_auto] items-center gap-10 max-w-7xl mx-auto min-h-[400px]">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-neutral-900 leading-snug mb-6 flex items-center flex-wrap gap-x-2
