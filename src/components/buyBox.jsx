...
return (
    <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4">
            <span className="text-2xl font-bold text-gray-800"> R${priceDiscount ?priceDiscount.toFixed(2) : price.toFixed(2)}</span>
            {priceDiscount && (
        ...
        <p className="text-sm text-gray-700 leading-relaxed">{description}</p>
           {children} 
        <button onClick={handleAddToCart} className="bg-pink-600 hover:bg-pink-700 text-white py-2 px-4 mt-4 rounded-xI text-base font-medium transition">
            Comprar
        </button>
    </div>
    );
